...
import Logo from '../images/logo/chami.svg';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <div>
      <aside
          ref={sidebar}
          className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-[#000000] ${
        ...
        >
          ...
          <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
            <NavLink to="/">
              <img className='w-[100px] text-center ml-2' src={Logo} alt="Logo" />
            </NavLink>
            <h1 className='text-whiten mr-8 font-extrabold text-2xl'>Chami</h1>
